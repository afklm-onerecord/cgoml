 ...
 *         &lt;element name="TotalPackageQuantity" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:8}QuantityType" minOccurs="0"/&gt;
...
public class LogisticsTransportMovementType {
    ...
    /**
     * Obtient la valeur de la propriété totalPackageQuantity.
     * 
     * @return
     *     possible object is
     *     {@link QuantityType }
    ...
    /**
     * Définit la valeur de la propriété totalPackageQuantity.
     * 
     * @param value
     *     allowed object is
     *     {@link QuantityType }
