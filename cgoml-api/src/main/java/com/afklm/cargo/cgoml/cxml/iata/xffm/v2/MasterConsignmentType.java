 ...
 *         &lt;element name="OnCarriageTransportMovement" type="{iata:datamodel:3}OnCarriageTransportMovementType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class MasterConsignmentType {
    ...
    protected List<OnCarriageTransportMovementType> onCarriageTransportMovement;
    ...
    /**
     * Gets the value of the onCarriageTransportMovement property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the onCarriageTransportMovement property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOnCarriageTransportMovement().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OnCarriageTransportMovementType> getOnCarriageTransportMovement() {
        if (onCarriageTransportMovement == null) {
            onCarriageTransportMovement = new ArrayList<OnCarriageTransportMovementType>();
        }
        return this.onCarriageTransportMovement;
    }
