...
ngOnInit(): void {
this.links=[{text:'Details',path:'/inbound-message/' + this.id.toString()},{text:'Message Validation Results',path:'/inbound-message/' + this.id.toString() + '/message-validation-result/list'}];
}
}
