package com.afklm.cargo.cgoml.populator.executor;
...
public class PopulatorLauncher {
	...
	public static void main(String[] args) {
		...
		try(FileSystemXmlApplicationContext appContext = new FileSystemXmlApplicationContext("classpath:applicationContext-cgoml-populator.xml",
																								"classpath:applicationContext-cgoml-repository.xml",
